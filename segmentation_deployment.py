...
def calculate_ndvi(image, red_band=4, nir_band=8):
...
def process_uploaded_file(uploaded_file):
    ...
    image = data[0]  
    ndvi = calculate_ndvi(image, red_band=3, nir_band=7)
...
def main():
    ...
    st.sidebar.image("C:/Users/asus/Semester-4/PCD/embos.png", use_container_width=True)
